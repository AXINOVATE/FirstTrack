...
<section class="dashboard-section" style="background-color:grey;">	
	<div class="container">
	<div id="myCarousel-5" class="carousel slide carousel2" data-ride="carousel">
		<div class="row mt-10 text-center c-dashboard">
			<h2 class="home-page-title">NayaGaadi <span style="color:#027cd5;">Category Dashboard</span></h2>
			<span class="span1-white"><i class="img-underline-white"></i></span>
			<div class="carousel-inner" role="listbox">
			   <?php $i=0;$j=0;$length=count($Products);?>
				  
				   <?php foreach($Products as $p){ ?>
				   <?php if($i==0&& $j==0){?>
					<div class="item active"><?php } elseif($i!=0&&$j==0){?>
					 <div class="item "> <?php }?>
							<div class="col-md-3 col-sm-3 col-xs-12 mb-20">
									<div id="flip-this" class="flip-horizontal"> 
										<div class="front"> 
											<center>
												<div class="p-border">
													<span class="counter"><?php echo $p['products']; ?></span>
										...
										<div class="back">
											<center>
												<div class="p-border">
													<img src="<?php echo $p['imgpath'];?>" alt="pic1" class="img-responsive" style="width: 42%;" >
													<p><?php echo $p['category']; ?></p>
												</div>
											</center>
										</div> 
