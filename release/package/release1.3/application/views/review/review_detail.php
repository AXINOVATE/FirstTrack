		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12 mt-10 mb-30">
					<img src="<?php echo $assetsPath; ?>/images/car-news2.jpg" alt="" style="width:100%; height:auto;"/>
				</div>
				<div class="col-md-12 col-sm-12 col-xs-12 mb-30">
					<div class="news-desc" >
						Getting Your Car Ready for the Track. Now that you've signed up for a track day with MVP Track Time, you need to prepare your car. The first course of 
					</div>
				</div>
			</div>
		</div>
