...
class CI_Email {
	...
	var	$smtp_host		= "Mail.NayaGaadi.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "sales@nayagaadi.com";		// SMTP Username
	var	$smtp_pass		= "Slokam@12345#!";		// SMTP Password
